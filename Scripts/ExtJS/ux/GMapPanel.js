    ...
    * <pre><code>*/
    ...
    initComponent: function () {
        ...
        if (window.google && window.google.maps) {
            ...
            //this.buildScriptTag('https://maps.google.com/maps/api/js?key=AIzaSyAdZ6EWxUxKzG6g0U2dbbrdZQu1pX0hhJc&sensor=false&callback=gmapapiready');
            if (!gMapKeyWebConf) {
                console.log('deve ser adicionada uma chave <add key="GOOGLE_MAPS_KEY" value="chave da API" /> na web.config desse(s) municipio(s)')
            }
            this.buildScriptTag('https://maps.google.com/maps/api/js?key=' + gMapKeyWebConf + '&sensor=false&callback=gmapapiready');
        }
        ...
        if (this.rendered) {
            ...
            Ext.defer(function () {
                if (this.gmapType === 'map') {
                    this.gmap = new google.maps.Map(this.getEl().dom, { zoom: this.zoomLevel, mapTypeId: google.maps.MapTypeId.ROADMAP, streetViewControl: false });
