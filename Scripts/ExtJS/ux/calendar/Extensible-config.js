...
Extensible.Config = {
    ...
    writeIncludes: function() {
        ...
        me.includeStylesheet('../../Scripts/ExtJS/resources/css/ext-all.css');
        me.includeStylesheet('../../Scripts/ExtJS/ux/calendar/resources/css/extensible-all.css');
        //   me.includeStylesheet(me.extensibleRoot + 'examples/examples.css?_dc=' + Extensible.version);

        //me.includeScript('../../Scripts/ExtJS/ext-base.js');
      //  me.includeScript(me.extJsRoot + 'ext-all' + suffix + '.js');
        me.includeScript('../../Scripts/ExtJS/ux/calendar/lib/extensible-all' + suffix + '.js');
